<template>
  <section class="home">
    <img src="@/assets/icons/home.png" alt="Profile" class="profile-img" />

    <div class="content">
      <h1 class="name">Shota Sasaki</h1>
      <ul class="bullet-points-top">
        <li>Chief Research Scientist, Team Leader at SB Intuitions Corp. <code>(shota.sasaki@sbintuitions.co.jp)</code></li>
